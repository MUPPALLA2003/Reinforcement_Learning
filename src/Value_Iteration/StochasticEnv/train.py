...
from src.Value_Iteration.StochasticEnv.model import ValueIterationStoc
...
if __name__ == "__main__":
    ...
    output = ValueIterationStoc(train_env)  
    ...
    render_env = gym.make('FrozenLake-v1', map_name="4x4", render_mode="rgb_array", is_slippery=True)  
